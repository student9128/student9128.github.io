! function e(t, n, r) {
        ...
        (function (n) {
            ...
            t.exports = function (t) {
                ...
                t.File = function (r, s, u) {
                    ...
                    if (this._guessedType = f, i.isArray(s)) this._base64 = a(s), this._source = t.Promise.as(this._base64, f), this._metaData.size = s.length;
                    else if (s && s.base64) {
                        var d = e("./browserify-wrapper/parse-base64"),
                            p = d(s.base64, f);
                        this._base64 = o(s.base64), this._source = t.Promise.as(p, f)
                    ...
                    else if (t._isNode && n.Buffer.isBuffer(s)) this._base64 = s.toString("base64"), this._source = t.Promise.as(this._base64, f), this._metaData.size = s.length;
                        ...
                        if (!i._previousSave) {
                            ...
                            if (i._source && s) {
                                ...
                                return i._base64 ? (r.base64 = i._base64, t._request("files", i._name, null, "POST", r)) : l(e).then(function (e) {
                                    return r.base64 = e, t._request("files", i._name, null, "POST", r)
                                })
                            }).then(function (e) {
                                return i._name = e.name, i._url = e.url, i.id = e.objectId, e.size && (i._metaData.size = e.size), i
                            }))
        ...
        t.exports = function (e) {
            ...
            e.History.started = !1, r.extend(e.History.prototype, e.Events, {
                ...
                start: function (i) {
                    ...
                    e.History.started = !0, this.options = r.extend({}, {
                        root: "/"
                    }, this.options, i), this._wantsHashChange = this.options.hashChange !== !1, this._wantsPushState = !!this.options.pushState, this._hasPushState = !!(this.options.pushState && window.history && window.history.pushState);
    ...
    18: [function (e, t, n) {
        ...
        t.exports = function (e) {
            e.Object = function (t, n) {
                ...
                if (i && (t = r.extend({}, i, t)), n && n.collection && (this.collection = n.collection),
                    this._serverData = {}, this._opSetQueue = [{}], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = r.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(t, {
                        silent: !0
    ...
    29: [function (e, t, n) {
        (function (n) {
            ...
            var r = e("underscore");
            t.exports = function (e) {
                e._config = e._config || {}, r.extend(e._config, {
        ...
        (function () {
            ...
            function r(e) {
                return function (t, n, r) {
                    n = O(n, r);
                    for (var i = j(t), s = e > 0 ? 0 : i - 1; s >= 0 && i > s; s += e)
            ...
            function s(e, t) {
                var n = U.length,
                    ...
                    s = "constructor";
                for (y.has(e, s) && !y.contains(t, s) && t.push(s); n--;) s = U[n], s in e && e[s] !== i[s] && !y.contains(t, s) && t.push(s)
            }
            var a = this,
                o = a._,
                u = Array.prototype,
            ...
            var T = function (e, t, n, r) {
                ...
                if (n.push(e), r.push(t), s) {
                    ...
                    for (; u--;)
                        if (!T(e[u], t[u], n, r)) return !1
                } else {
                    var c, l = y.keys(e);
                    if (u = l.length, y.keys(t).length !== u) return !1;
                    for (; u--;)
                        if (c = l[u], !y.has(t, c) || !T(e[c], t[c], n, r)) return !1
                }
